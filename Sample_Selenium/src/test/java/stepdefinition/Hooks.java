...
//		System.setOut(new PrintStream(new FileOutputStream(System.getProperty("user.dir") + ConfigFileReader.getLoggerPath() + "Logger" + "_" + timestamp2 + ".txt")));
		...
		Menus = PageFactory.initElements(driver, object_repository.Locators.MenuObjects.class);
		LoginEip = PageFactory.initElements(driver, object_repository.Locators.LoginEipObjects.class);
		Login = PageFactory.initElements(driver, object_repository.Locators.LoginObjects.class);
		commonObjects = PageFactory.initElements(driver, object_repository.Locators.CommonControlObject.class);
...
//                scenario.attach(screenshot, "image/png", "Paased Step Screenshot");
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
//        }
...
//	        }
		...
		// Enable the below script if you want all test cases screenshots in your HTML report it self
//		
//		try {
//            // Take screenshot and embed it in the report
//            byte[] screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.BYTES);
